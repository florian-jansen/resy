...
test_that("resy_check_eunis: valid data frame with all columns passes silently", {
...
test_that("resy_check_eunis: valid sf object passes silently", {
...
test_that("resy_check_eunis: missing Longitude/Latitude columns errors", {
...
test_that("resy_check_eunis: coordinate error halts further checks", {
  ...
  # Should exit early with coordinate error, not checking PlotObservationID
  expect_length(result$errors, 1)
...
test_that("resy_check_eunis: all optional columns present removes warnings", {
